...
return [
    ...
    'Online store'                   => '在线商店',
    'Local addon'                    => '本地插件',
    'Https tips'                     => '当前你无法在插件管理中在线安装TokenMan市场中的插件，请前往 <a href="http://www.fastadmin.net/store.html" target="_blank" class="">TokenMan插件市场</a> 中下载后进行离线安装。',
    'Conflict tips'                  => '此插件中发现和现有系统中部分文件发现冲突！以下文件将会被影响，请备份好相关文件后再继续操作',
    'Login tips'                     => '此处登录账号为<a href="http://www.fastadmin.net" target="_blank">TokenMan官网账号</a>',
    ...
    'Not login tips'                 => '你当前未登录TokenMan，登录后将同步已购买的记录，下载时无需二次付费！',
