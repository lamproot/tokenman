define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'template', 'upload'], function ($, undefined, Backend, Table, Form, Template, Upload) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'chatbot/currency/index',
                    add_url: 'chatbot/currency/add',
                    edit_url: 'chatbot/currency/edit',
                    del_url: '',
                    multi_url: '',
                }
            });
...
showToggle:false,
                ...
                columns: [
                    [
                        ...
                        {field: 'id', title: 'ID'},
                        {field: 'currency', title: __('Coin name')},
                        {field: 'exchange', title: __('Exchange')},
                        {field: 'opreate_username', title: __('opreate_username')},
