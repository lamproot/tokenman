define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'template', 'upload'], function ($, undefined, Backend, Table, Form, Template, Upload) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'chatbot/twitterlog/index',
                    add_url: 'chatbot/twitterlog/add',
                    edit_url: 'chatbot/twitterlog/edit',
                    del_url: 'chatbot/twitterlog/del',
                    multi_url: '',
                }
            });
...
showToggle:false,
                ...
                columns: [
                    [
                        {field: 'id', title: 'ID'},
                        {field: 'twitter', title: __('Twitter')},
                        {field: 'content', title: __('Content'), width:200},
