define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'template', 'upload'], function ($, undefined, Backend, Table, Form, Template, Upload) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'activity/articlemanage/index?activity_id='+$_GET['activity_id'],
                    add_url: '',
                    edit_url: '',
                    del_url: '',
                    multi_url: 'activity/articlemanage/multi',
                }
            });
                    ...
                    [
                        ...
                        {field: 'operate', title: __('Operate'), table: table,
                            ...
                            buttons: [{
                                  ...
                                  url: 'activity/articlemanage/detail'
                              }]
                        }
                        //{field: 'operate', title: __('Operate'), table: table,
                            ...
                            //             icon: 'fa fa-list',
                            //             classname: 'btn btn-info btn-xs btn-detail btn-dialog',
                            //             url: 'activity/articlemanage/user',
        ...
        user: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'activity/articlemanage/user',
                    add_url: '',
                    edit_url: '',
                    del_url: '',
                    multi_url: '',
            ...
            formatter: {
                ...
                activity_user: function (value, row, index) {
                    if (row.type && row.type == 0) {
                        return '<a href="activity/articlemanage/user?activity_id=' +row.id+ '">查看活动用户</a>';
                    } else {
                        return '<a href="activity/articlemanage/user?activity_id=' +row.id+ '">查看活动用户</a>';
                    }
                }
